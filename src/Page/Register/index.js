    ...
    <main className="main">
      <div className="full-page">
        <div className="web-center-block register">
          <div className="enter-frame" style={{ textAlign: 'center' }}> <img src="/storage/meta.png" alt="logo" className="enter-logo" />
            <h1 style={{ color: '#fff' }}>Thành viên đã đăng ký</h1>

            <form action="/ajax/register" className="register_form" method="post">
              <div className="text-block">
                <p style={{ marginTop: 0 }}> Để bảo vệ quyền lợi của mình , thành viên phải đăng ký họ tên theo CMND và tài khoản ngân hàng là
              ...
              <div className="input-block">
                <label htmlFor className="title">Người giới thiệu</label>
              ...
              {/*<div className="input-block">*/}
              {/*  <label className="title" htmlFor>ZaloID</label>*/}
              ...
              {/* <div className="input-block">
                <div className="input-verification-code-block">
                  ...
                  <div style={{paddingTop: "10px"}} className="verification">
                    <ReCAPTCHA
                      sitekey="6LfixTAoAAAAACNNi8XfDcLS49vcZ3b3SuhWYMZU"
                      onChange={(value)=>{
                        setCaptCha(value)
                      }}
                    />
              ...
              <button onClick={(e) => { handleLogin(e) }} className="btn1 login-btn submit text-white" data-loading-text="Chế biến...">Đăng ký</button>
              <div className="link-area"> <a href target="_blank" className='text-warning'>Dịch vụ chăm sóc khách</a> <Link to="/login" className='text-success'>Đăng nhập</Link> </div>
