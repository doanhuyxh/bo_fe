...
function Chart(props) {
            ...
            setTimeout(() => {
              window.sweetAlert(
                ...
                `Đặt lệnh thành công với Mã GD: ${
                  ...
                  data.betRecordType === "BetUp" ? "Mua" : "Bán"
                }`,
                "success"
              );
            }, 1500);
  ...
  const handleRenderTextType = (type) => {
    if (type === BET_TYPE.UP) {
      ...
      return { text: "Mua", type: "result_even" };
    }
    return { text: "Bán", type: "result_odd" };
  };
  ...
  function handleBet(e) {
    if (e === 1) {
      ...
      dataBetRecord.betRecordType = BET_TYPE.DOWN;
      setDataBetRecord({
        ...dataBetRecord,
    ...
    if (dataBetRecord.betRecordType === undefined) {
      window.sweetAlert("", "Vui lòng chọn 1 Mua hoặc Bán", "warning");
      return;
    }

    if (60 - +moment().format("ss") < 15) {
      window.sweetAlert("", "Phiên giao dịch sẽ thực hiện sau 15s", "warning");
    } else {
      ...
      if (dataBetRecord.betRecordAmountIn < 100000) {
        window.sweetAlert("", "Số tiền phải lớn hơn hoặc bằng 100k", "warning");
      } else if (dataBetRecord.betRecordAmountIn > 500000000) {
        window.sweetAlert("", "Số tiền phải bé hoặc bằng 500tr", "warning");
      } else if (
        newWallets[0] &&
        newWallets[0].balance < dataBetRecord.betRecordAmountIn
      ) {
        window.sweetAlert("", "Số tiền vượt quá toài khoản hiện có", "warning");
      } else {
        window.sweetAlert(
          {
            ...
            text: `
                                    <table class="table__bet table-borderless">
                                      <tr>
                                        <td>Tên sản phẩm</td>
                                        <td>${typeMoney}/USD</th>                                     
                                      </tr>
  ...
  useEffect(() => {
    ...
    fetch("https://notify.miraehktrading.com/Notify")
      ...
      return () => {
        clearInterval(intervalId); // Clear interval khi component unmounted
      };
  ...
  return (
    <>
      <nav className="nav bg-dark">
        <div className="logo" id="logo_header">
          <img src="./assets/images/loading.gif" />
          <a>
            <b className="now_datetime_class"> Thời gian: </b>
            <span id="now_datetime">
              {" "}
              {moment(payloadBTC._id || "").format("YYYY/MM/DD HH:mm:ss")}
            </span>
          </a>
        </div>
        <div id="text_slide">
          <Marquee speed={20}>
            {notify.map((item) => {
              if (item.isBuy) {
                return (
                  <div key={item.id}>
                    <p className="text-danger fs-5 px-2">{item.content}</p>
                  </div>
                );
              } else {
                return (
                  <div key={item.id}>
                    <p className="text-primary fs-5 px-2">{item.content}</p>
                  </div>
                );
              }
            })}
      ...
      <div
        ...
        style={{ width: "100%", height: "47px", paddingBottom: "4px" }}
      >
        <iframe
          scrolling="no"
      ...
      <div className="container-fluid" style={{ marginTop: "4px" }}>
        <div id="thi_truong" className="choice-list">
          <div className="frame-title">
            <img src="./assets/images/online.gif" />
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {ethPrice
                        ? ethPrice.substring(0, ethPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        ethPrice ? ethPrice[ethPrice.length - 2] : "-"
                      }${
                        ethPrice ? ethPrice[ethPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadETH.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadETH.percentage ? payloadETH.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {adaPrice
                        ? adaPrice.substring(0, adaPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        adaPrice ? adaPrice[adaPrice.length - 2] : "-"
                      }${
                        adaPrice ? adaPrice[adaPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadADA.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadADA.percentage ? payloadADA.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {bnbPrice
                        ? bnbPrice.substring(0, bnbPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        bnbPrice ? bnbPrice[bnbPrice.length - 2] : "-"
                      }${
                        bnbPrice ? bnbPrice[bnbPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadBNB.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadBNB.percentage ? payloadBNB.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {dogePrice
                        ? dogePrice.substring(0, dogePrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        dogePrice ? dogePrice[dogePrice.length - 2] : "-"
                      }${
                        dogePrice ? dogePrice[dogePrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadDOGE.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadDOGE.percentage ? payloadDOGE.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {dotPrice
                        ? dotPrice.substring(0, dotPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        dotPrice ? dotPrice[dotPrice.length - 2] : "-"
                      }${
                        dotPrice ? dotPrice[dotPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadDOT.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadDOT.percentage ? payloadDOT.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {ltcPrice
                        ? ltcPrice.substring(0, ltcPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        ltcPrice ? ltcPrice[ltcPrice.length - 2] : "-"
                      }${
                        ltcPrice ? ltcPrice[ltcPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadLTC.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadLTC.percentage ? payloadLTC.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_701" game={701}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {xrpPrice
                        ? xrpPrice.substring(0, xrpPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        xrpPrice ? xrpPrice[xrpPrice.length - 2] : "-"
                      }${
                        xrpPrice ? xrpPrice[xrpPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadXRP.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadXRP.percentage ? payloadXRP.percentage : "--"} %
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="list-item down" id="choices_702" game={702}>
                ...
                <div className="item-section2">
                  <div className="list-item-price">
                    <div className="price">
                      {btcPrice
                        ? btcPrice.substring(0, btcPrice.length - 2)
                        : "----"}
                      <span className="l">{`${
                        btcPrice ? btcPrice[btcPrice.length - 2] : "-"
                      }${
                        btcPrice ? btcPrice[btcPrice.length - 1] : "-"
                      }`}</span>
                    </div>
                  </div>
                  <div
                    className={`list-item-updown ${
                      payloadBTC.percentage * 10000 > 0 ? "up" : "down"
                    }`}
                  >
                    <div className="number">
                      {" "}
                      {payloadBTC.percentage ? payloadBTC.percentage : "--"}%
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* dong cua */}
        <div className="game_cover" style={{ display: "none" }}>
          Đóng cửa ...
        </div>
        {/* chart */}
        <div className="row">
          <div className="canvas-run">
                        ...
                        <div className="tap-content">
                          <div className="tab-pane active" id="binaryBox">
                            ...
                            >
                              ...
                              {/*    <p>Kiểu:</p>*/}
                              {/*    <select id="right_roomList" className='text-dark'*/}
                              {/*            onChange={(e) => {*/}
                              ...
                              <div className="tab-current sub-title2">
                                <div className="name">
                                  Giao dịch:{" "}
                                  <span id="gameid" ckt-name="now_period">
                                    {moment()
                                      .add(0, "m")
                                      .format("YYYYMMDDHHmm")}
                                  </span>
                                ...
                                <div className="bet-inforight">
                                  ...
                                  {/* <button onClick={(e) => {
                                    ...
                                    `,
                                                                    ...
                                                                    }} type="submit" className="btn-buy">Xác nhận giao
                                                                        dịch
                                                                    </button> */}
                                </div>
                              </form>
            ...
            <div className="user-list" id="user_record">
              {" "}
              {/* 交易紀錄：客人交易紀錄 */}
              ...
              {/* 本日交易：現場客人交易紀錄 */}
              <div className="record-half2 now">
