...
import LoginUser from "./../src/Page/Login/login"
    ...
    <>
      ...
      <Router>
        <Switch>
            ...
            {isUserLoggedIn ? <Route exact path="/" component={(props) => <Layout classNameChart="chart-2" className="homePage-second"    {...props} member={{}} Component={ChartParent} />} /> : <Route exact path="/" component={(props) => <Login className="loginPage" {...props} />} />}

            {isUserLoggedIn ? null : <Route exact path="/register" component={(props) => <Register  {...props} className="loginPage" />} />}
            <Route exact path="/login" component={(props) => <LoginUser/>} />
            {isUserLoggedIn ? (
            ...
            { isUserLoggedIn ? <Route exact path="/trade" component={(props) => <Layout classNameChart="chart-2" className="homePage-second"    {...props} member={{}} Component={ChartParent} />} /> : <Route component={(props) => <Login  {...props} className="loginPage" />} />}
        </Switch>
      </Router>
